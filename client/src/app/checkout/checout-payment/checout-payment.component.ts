...
export class ChecoutPaymentComponent implements AfterViewInit {
...
constructor(private basketService: BasketService, private checkoutService: CheckoutService, private toastr: ToastrService, private router: Router) { }
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe('pk_test_51L5BNeGt9MqMS2K84oJWnMByv5zCqfCNq71Y86RRSYRandxkZfKQ48yeM8Pv3srxvhLYQ9ZiLsy69n7MRTtxYNe600WwKQ6P5j')
  ...
  onChange(event){
    ...
    switch(event.elementType){
      ...
      case 'cardExpiry':
      this.cardExpityValid = event.complete
      break;
